    ...
    <div class="max-w-4xl mx-auto">
        ...
        <div class="mb-8">
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-3xl font-bold text-foreground mb-2">Crear Semillero</h1>
                    <p class="text-muted-foreground">Registra un nuevo semillero de investigación en el sistema CEFA</p>
                </div>
        ...
        <div class="bg-card rounded-lg shadow-sm border border-border overflow-hidden">
            <div class="px-6 py-4 border-b border-border bg-muted/30">
                <div class="flex items-center space-x-3">
                    ...
                    <div>
                        <h3 class="text-lg font-semibold text-foreground">Información del Semillero</h3>
                        <p class="text-sm text-muted-foreground">Completa los datos del nuevo semillero de investigación</p>
                    </div>
                </div>
            </div>

            <form action="{{ route('semilleros.store') }}" method="POST" class="p-6" enctype="multipart/form-data">
                @csrf
                ...
                <div class="space-y-6">
                    ...
                    <div class="space-y-2">
                        <label for="titulo" class="block text-sm font-medium text-foreground">
                            <div class="flex items-center space-x-2">
                                ...
                                <span>Nombre del Semillero</span>
                            </div>
                        </label>
                        <input type="text" id="titulo" name="titulo" value="{{ old('titulo') }}"
                            ...
                            placeholder="Ingresa el nombre del semillero" required>
                    </div>
                    ...
                    <div class="space-y-2">
                        ...
                        <textarea id="descripcion" name="descripcion" rows="4"
                            ...
                            placeholder="Describe los objetivos y alcance del semillero de investigación">{{ old('descripcion') }}</textarea>
                    </div>
                </div>
                ...
                <div class="relative">
                    ...
                    <div id="dropZone"
                        ...
                        <div class="flex flex-col items-center space-y-4">
                            ...
                            <div class="space-y-2">
                                <h4 class="text-lg font-semibold text-foreground">Seleccionar Logo</h4>
                                <p class="text-sm text-muted-foreground">
                                    Arrastra y suelta tu archivo aquí o
                                    <span class="text-primary font-medium hover:text-primary/80 cursor-pointer">haz clic
        ...
        <div class="mt-6 bg-blue-50 border border-blue-200 rounded-lg p-4">
            <div class="flex items-start space-x-3">
                ...
                <div>
                    <h4 class="font-medium text-blue-800 mb-1">Registro de Semillero</h4>
                    <p class="text-sm text-blue-700">Una vez creado el semillero, podrás asignar integrantes, crear
                        proyectos
                        de investigación y hacer seguimiento a las diferentes fases de desarrollo.</p>
                </div>
            </div>
        </div>
    </div>
