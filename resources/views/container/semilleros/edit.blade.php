            ...
            <div class="space-y-6">
                ...
                <div class="space-y-2">
                    ...
                    <input type="text" id="titulo" name="titulo"
                           value="{{ old('titulo', $semillero->titulo) }}"
                           ...
                           placeholder="Ingresa el título del semillero"
                           required>
                </div>
                ...
                <div class="space-y-2">
                    ...
                    <input type="text" id="created_at" 
                           value="{{ $semillero->created_at->format('Y-m-d H:i') }}"
    ...
    <div class="mt-6 bg-blue-50 border border-blue-200 rounded-lg p-4">
        <div class="flex items-start space-x-3">
            ...
            <div>
                ...
                <p class="text-sm text-blue-700">Los cambios realizados se aplicarán inmediatamente. Asegúrate de que la información sea correcta antes de guardar.</p>
            </div>
        </div>
    </div>
</div>
