                ...
                <tbody class="divide-y divide-border">
                    @forelse ($directores as $index => $director)
                        <tr class="hover:bg-muted/30 transition-colors duration-150">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="flex items-center space-x-2">
                                    <!-- Convirtiendo botones Bootstrap a diseño SENA -->
                                    <a href="{{ route('directores.edit', $director->id) }}" 
                                       class="bg-secondary hover:bg-secondary/80 text-secondary-foreground px-3 py-2 rounded-md text-sm font-medium transition-colors duration-200 flex items-center space-x-1">
                                    ...
                                    <form action="{{ route('directores.destroy', $director->id) }}" method="POST" class="inline">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit" 
                                                class="bg-red-50 hover:bg-red-100 text-red-600 hover:text-red-700 px-3 py-2 rounded-md text-sm font-medium transition-colors duration-200 flex items-center space-x-1 border border-red-200 hover:border-red-300" 
                        ...
                        <tr>
                            <td colspan="4" class="px-6 py-12 text-center">
                                <div class="flex flex-col items-center space-y-4">
                                    ...
                                    <div>
                                        <h3 class="text-lg font-medium text-foreground mb-1">No hay directores registrados</h3>
                                        <p class="text-muted-foreground mb-4">Comienza agregando el primer director al sistema</p>
                                        <a href="{{ route('directores.create') }}" 
