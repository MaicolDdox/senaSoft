            ...
            <table class="w-full">
                <thead class="bg-muted/50 border-b border-border">
                    <tr>
                        ...
                        <th class="px-6 py-4 text-left text-sm font-medium text-muted-foreground">Correo Electrónico</th>
                        ...
                        <tr class="hover:bg-muted/30 transition-colors duration-150">
                            ...
                            <td class="px-6 py-4">
                                <div class="flex justify-center space-x-2">
                                    ...
                                    <form action="{{ route('aprendices.destroy', $aprendiz->id) }}" method="POST" class="inline"
                            ...
                            <td colspan="4" class="px-6 py-12 text-center">
                                <div class="flex flex-col items-center space-y-4">
                                    ...
                                    <div class="text-center">
                                        <h3 class="text-lg font-medium text-foreground mb-1">No hay aprendices registrados</h3>
                                        <p class="text-sm text-muted-foreground mb-4">Comienza registrando el primer aprendiz en el sistema</p>
                                        <a href="{{ route('aprendices.create') }}" 
    ...
    <div class="mt-6 bg-blue-50 border border-blue-200 rounded-lg p-4">
        <div class="flex items-start space-x-3">
            ...
            <div>
                ...
                <p class="text-sm text-blue-700">Los aprendices pueden acceder al sistema con sus credenciales para participar en grupos de semilleros de investigación y gestionar sus proyectos académicos.</p>
            </div>
        </div>
    </div>
</div>
